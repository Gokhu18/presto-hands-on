...
tar -jxf prestoadmin-1.1-offline.tar.bz2
cd prestoadmin/
...
# presto-admin will ask you to provide the following: 
# user name for ssh=ec2-user
# port=22
# internal IP* of coordinator
# internal IP* of workers separated by spaces
...
hive.metastore.uri=thrift://<coordinator-ip>:9083
